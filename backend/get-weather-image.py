...
def download():
    ...
    shutil.move(filename, path + '/' + mytimestamp + '.png')
    ...
    frames[0].save('web-images/weather_animation.gif', format='GIF', append_images=frames[1:], save_all=True, duration=300, loop=0)
